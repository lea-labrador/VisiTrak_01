...
export default function EntryScreen() {
  ...
  const sizes = {
    cardMaxWidth: isTablet ? (isLargeTablet ? 940 : 840) : 580,
    ...
    qrCode: (isShortHeight ? 120 : isTablet ? 150 : 140) * scale * elementBump * qrBump,
    qrFrameExtra: 10 * scale,
    qrMarginBottom: (isShortHeight ? 16 : 22) * scale,
    scanFont: (isShortHeight ? 17 : isTablet ? 19 : 18) * scale * elementBump,
    buttonFont: (isShortHeight ? 15 : isTablet ? 17 : 16) * scale * elementBump * buttonBump,
    buttonMinHeight: (isShortHeight ? 46 : isTablet ? 56 : 50) * scale * elementBump * buttonBump,
    buttonWidth: isTablet ? width * 0.7 : isSmallPhone ? width * 0.9 : width * 0.78,
    buttonMarginTop: (isShortHeight ? 14 : 18) * scale,
    buttonIcon: (isTablet ? 24 : 22) * scale * elementBump * buttonBump,
    arrowIcon: (isTablet ? 20 : 18) * scale * elementBump * buttonBump,
            ...
            <View style={{ width: "100%", alignItems: "center" }}>
              ...
              >
                ...
                >
                  ...
                  >
                    <Image
                      source={require("../assets/images/in_code.png")}
                      style={{
                        width: sizes.qrCode,
                        height: sizes.qrCode,
                      }}
